...
function compassCloak() {
  localStorage.setItem("cloakedTitle", "Home | Compass");
  localStorage.setItem("cloakedIcon", "/assets/img/compass-icon.webp");
  tabCloak();
}
...
if (
  clickoffButtonCheck === "disabled" ||
  clickoffButtonCheck === "" ||
  clickoffButtonCheck === null
) {
